        ...
        <div class="offcanvas-header d-flex flex-column" style="padding: 22px;">
            <div class="bg-body-secondary border rounded-pill border-0 d-flex justify-content-between align-items-center"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <span class="text-start d-flex flex-column" style="margin-left: 15px;"><span class="fw-bold"
        ...
        <div class="offcanvas-body d-flex flex-column pt-0">
            ...
            <ul v-if="infos.user" class="nav nav-pills flex-column mb-auto">
                ...
                <li id="link-menu" class="nav-item">
                    <a id="link-menu" class="nav-link" href="#">
                        <svg class="me-2"
                ...
                <li class="nav-item" style="opacity: 0.80;"><a id="link-menu" class="nav-link" href="#"><svg class="me-2"
                ...
                <li v-if="infos.boutique.length !== 0" class="nav-item" style="opacity: 0.80;"><a id="link-menu" class="nav-link"
                        href="#"><svg class="me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em"
                ...
                <li id="link-menu" class="nav-item" href="#"><a id="link-menu" class="nav-link" href="#"><svg class="me-2"
                            xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em"
                            fill="currentColor">
                            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                            <path
                ...
                <li v-if="infos.boutique.length !== 0" id="link-menu" class="nav-item">
                    <a id="link-menu" class="nav-link" href="/boutique/articles">
                ...
                <li id="link-menu" class="nav-item">
                    <a id="link-menu" class="nav-link" @click="desconnect">
                        <i class="fas fa-power-off me-2"></i> Décommexion
                    </a>
                </li>
            </ul>
